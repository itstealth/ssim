export const ANNA = "/faculty-research/faculty-photos/5-Dr-V-Annapurna.png";
export const Balani = "/faculty-research/faculty-photos/20-Dr-M-Balanji-Reddy.png";
export const BinalK = "/faculty-research/faculty-photos/28-Mr-Bipul-Kumar.png";
export const Chaitha = "/faculty-research/faculty-photos/22-Mr-M-Chaithanya.png";
export const Damandeep = "/faculty-research/faculty-photos/16-Mrs-Damandeep-Johar.png";
export const DINES = "/faculty-research/faculty/DINESH.webp";
export const DrArij = "/faculty-research/faculty/DR-Arijit.webp";
export const DrHari = "/faculty-research/faculty-photos/4-Dr-K-S-Harish.png";
export const DrJaya = "/faculty-research/faculty-photos/6-Dr-V-Jayalakshmi.png";
export const DrPAV = "/faculty-research/faculty-photos/3-Dr-Pavan-Patel.png";
export const DrRaj = "/faculty-research/faculty-photos/8-Dr-N-C-Rajyalakshmi.png";
export const Gowri = "/faculty-research/faculty-photos/26-Dr-P-Gowri-Kusuma.png";
export const Gracena = "/faculty-research/faculty-photos/13-Dr-K-Grace-Mani.png";
export const JKame = "/faculty-research/faculty-photos/31-Dr-Jada-Kameswari.png";
export const KiranK = "/faculty-research/faculty-photos/29-Dr-K-Kiran-Kumar.png";
export const Kommu = "/faculty-research/faculty-photos/18-Mrs-Kiranmayi-Patel.png";
export const LOHIT = "/faculty-research/faculty/LOHIT.webp";
export const MrMa = "/faculty-research/faculty-photos/14-Mr-T-Madhav-Murthy.png";
export const Murali = "/faculty-research/faculty-photos/30-Mr-G-Murali-Krishna-Patnaik.png";
export const NRKS = "/faculty-research/faculty-photos/9-Mr-N-R-K-S-Chakravarthy.png";
export const PARDH = "/faculty-research/faculty/PARDHASARADHI.webp";
export const Pushpa = "/faculty-research/faculty-photos/21-Dr-M-Pushpa.png";
export const rahul = "/faculty-research/faculty-photos/15-Mr-Rahul-Jain.png";
export const chandra = "/faculty-research/faculty-photos/2-Dr-S-F-Chandra-Sekhar.png";
export const Shambhavi = "/faculty-research/faculty-photos/27-Dr-Shambhavi-Tamrakar.png";
...
export const ramana = "/faculty-research/faculty-photos/1-Ramana-Rao.png";
