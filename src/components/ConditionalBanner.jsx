...
const routeConfig = {
  ...
  "/about/academic-advisory-board": {
    ...
    breadcrumbs: [
      ...
      { label: "About", href: "/about" },
      {
        label: "Academic Advisory Board",
        href: "/about/academic-advisory-board",
        isActive: true,
      },
    ],
  },
  ...
  "/programs/pgdm-triple-specialisation": {
    ...
    breadcrumbs: [
      ...
      { label: "Programs", href: "/programs" },
      {
        label: "PGDM Triple Specialisation",
        href: "/programs/pgdm-triple-specialisation",
        isActive: true,
      },
    ],
  },
  ...
  "/students-life/students-feedback": {
    ...
    breadcrumbs: [
      ...
      { label: "Student Life", href: "/students-life" },
      {
        ...
        href: "/students-life/students-feedback",
        isActive: true,
      },
    ],
  },
  ...
  "/students-life/students-achievements": {
    ...
    breadcrumbs: [
      ...
      { label: "Student Life", href: "/students-life" },
      {
        ...
        href: "/students-life/students-achievements",
        isActive: true,
      },
    ],
  },
