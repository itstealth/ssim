...
// The mobile auto-scroll was previously driven by a setInterval useEffect,
// which forced this to be a Client Component and added JS overhead.
// It is now replaced by a pure CSS scroll-snap layout; users can swipe
// on mobile, and the desktop flex-wrap layout is unaffected.
...
export default function AccredBar() {
  return (
    <div className={`py-[18px] ${secondHomeTheme.shellMuted}`}>
      <div className="flex items-center lg:justify-center gap-4 lg:gap-9 px-4 lg:px-[60px] flex-nowrap lg:flex-wrap overflow-x-auto lg:overflow-x-visible snap-x snap-mandatory scroll-pl-4 lg:scroll-pl-[60px] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        {accreds.map((a) => (
          <div
            key={a.label}
