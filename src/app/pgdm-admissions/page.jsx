...
<div className="fixed bottom-0 left-0 right-0 bg-navy px-4 py-3 shadow-2xl z-50 md:hidden border-t border-white/10">
  <div className="flex items-center gap-3">
    <a href="tel:+919391114948" className="flex items-center justify-center w-11 h-11 shrink-0 bg-purple-600 hover:bg-purple-700 rounded-full transition-colors ph-anime shadow-lg">
...
<a href="tel:+919391114948" className="fixed left-6 bottom-6 z-50 hidden md:flex items-center justify-center w-14 h-14 bg-purple-600 hover:bg-purple-700 rounded-full shadow-lg transition-all hover:scale-110 ph-anime">
